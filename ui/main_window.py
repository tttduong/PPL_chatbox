...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.chat_display.add_message(
            self.bot_name,
            'Welcome back! I am your Virtual Assistant 👋 I can help you manage your calendar 😁. You can try: "show calendar today", "check pending event  22/12/2025", "set meeting 15:30 17:00 today".'
        )
